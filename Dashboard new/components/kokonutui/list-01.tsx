  ...
  return (
    ...
    >
      ...
      <div className="p-3 border-b border-zinc-100 dark:border-zinc-800">
        ...
        <h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-50">{totalBalance}</h1>
      </div>
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  {account.description && (
                    <p className="text-[10px] text-zinc-600 dark:text-zinc-400">{account.description}</p>
                  )}
                </div>
              </div>
